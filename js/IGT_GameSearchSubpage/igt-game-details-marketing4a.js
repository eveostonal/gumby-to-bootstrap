...
document.igt_gs_marketing_main = function () {
    ...
    document.igt.prm.handlers.setupMarketingTabModalsAsyncPostback = function () {
        SetupModals();
        if (buttonsOnUpdatePanelsHandlers) {
            buttonsOnUpdatePanelsHandlers();
        }
    };
    document.igt.prm.pageRequestManager.add_endRequest(document.igt.prm.handlers.setupMarketingTabModalsAsyncPostback);
